...
safe_osrmTable <- function(src_sf, dst_sf, measure = c("distance", "duration"),
  ...
  # This line sets a global option for the osrm package to know which server to use.
  # This is the correct syntax for your version of the package (4.2.0).
...
car_results <- safe_osrmTable(src = all_facilities, dst = demand_pts,
                              ...
                              server_port = 5000,
                              chunk_size = 500) # Adjust chunk size based on your system's memory and OSRM server's capacity
...
foot_results <- safe_osrmTable(src = all_facilities, dst = demand_pts,
                               ...
                               server_port = 5001,
                               chunk_size = 500) # Use the same or different chunk size
